...
public class ProcEmpUpdate1 extends JFrame{
	 ...
	 *   @param p_deptno - 부서 번호를 입력받아서 멀티 레코드 처리 실습
	...
	public static void main(String[] args) {
		...
		String user_input1 = JOptionPane.showInputDialog("사원번호를 입력하세요");
		int empno = 0;
		
		if(user_input1 !=null || user_input1.length()>1) {
			empno = Integer.parseInt(user_input1);
		}
		neu1.salUpdate2(empno);
