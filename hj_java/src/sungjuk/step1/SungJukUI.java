...
public class SungJukUI extends JFrame implements ActionListener {
	...
	JButton jbtn_plus = new JButton("추가");
...
/* DefaultCellRenderer는 TableCellEditor인터페이스와 TreeCellEditor인터페이스를 모두 구현함
 * 이 에디터는 셀을 편집하기 위해 JTextField, JComboBox 또는 JCheckBox를 반환하도록 디자인 됨
 */
