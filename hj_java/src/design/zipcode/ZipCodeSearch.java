...
/* String배열에 있는 정보를 굳이 벡터에 담아야 함  > 생성자 선택을 Vector타입으로 결정했기 때문이다.
 * 벡터 자체는 값을 가지고 있지 않는 상태  > 값은 1차 배열 안에 초기화 되어 있음 > 이것을 벡터에 재 초기화 한다.
 * 그 후에 콤보박스를 생성하고 화면에 장착해야 리스트에서 값을 볼 수 있을 것이다. */
	...
	public static void main(String[] args) {
		ZipCodeSearch sear = new ZipCodeSearch();
		sear.initDisplay();
	}
