...
public class SpringAddressBook extends JFrame {
 ...
 // 메인 메소드는 AddressBook의 인스턴스를 생성하고 보여주는 일만 함
 ...
 // 초기화 작업은 컴포넌트들의 값을 셋팅하고 배치합니다.
    private void initComponents() {
     ...
     // DefaultTableModel을 상속받은 MyTableModel 클래스가 테이블의 데이타를 담당
	...
	// 모든 GUI 컴포넌트의 설정이 완료되면 전체 데이터를 조회
		try {
			refreshData();
		} catch (Exception e) {
 ...
 // 조회 메뉴나 조회 아이콘 선택시 작업을 정의
	private void detailActionPerformed() {

	}

 // 입력 메뉴나 입력 아이콘 선택시 작업을 정의
	private void addActionPerformed(ActionEvent evt) {

	}

 // 수정 메뉴나 수정 아이콘 선택시 작업을 정의
	public void updateActionPerformed(AddressVO pvo) {

	}

 // 삭제 메뉴나 삭제 아이콘 선택시 작업을 정의
